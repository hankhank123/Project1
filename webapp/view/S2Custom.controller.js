...
{
var dd = 
this.getView().byId("list").getItems()[1].getSecondStatus().getId();
$("#" + dd).hide();
this.getView().byId(dd).setState="";
}
...
//			}
	...
	//	});
			...
			for( var i=0; i< aCreateBy.length; i++)
			{
				var oCustomFilter = this._createFilterItem("Value:"+ aCreateBy[i].ernam, aCreateBy[i].ernam);
