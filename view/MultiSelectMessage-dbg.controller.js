 ...
 */
sap.ui.controller("cross.fnd.fiori.inbox.view.MultiSelectMessage", {
	...
	onItemSelect: function(oEvent) {
		...
		cross.fnd.fiori.inbox.util.MultiSelect.openDetailDialog(oDetailInfo, this.fnClose, function() {
			cross.fnd.fiori.inbox.util.MultiSelect.openMessageDialog(that.aSuccessList, that.aErrorList, that.fnClose);
		});
	},
