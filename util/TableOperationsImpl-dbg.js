				...
				for (var i = 0; i < this.aSearchableFields.length; i++) {
					if(this.aSearchableFields[i] === "CompletionDeadLine" || this.aSearchableFields[i] === "CreatedOn"){
						this.aSearchFilter.push(new Filter({
							...
							test:$.proxy(function(oValue){
								var formattedDate = cross.fnd.fiori.inbox.Conversions.formatterDate(new Date(oValue));
						...
						this.aSearchFilter.push(new Filter({
							path:this.aSearchableFields[i], 
							test:$.proxy(function(oValue){
								var displayStatus = cross.fnd.fiori.inbox.Conversions.formatterStatus.call(this.oView, "TODO",oValue);
						...
						this.aSearchFilter.push(new Filter({
							path:this.aSearchableFields[i], 
							test:$.proxy(function(oValue){
								var displayPriority = cross.fnd.fiori.inbox.Conversions.formatterPriority.call(this.oView, "TODO",oValue);
