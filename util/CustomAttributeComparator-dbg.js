 ...
 */
jQuery.sap.declare("cross.fnd.fiori.inbox.util.CustomAttributeComparator");
jQuery.sap.require("sap.ui.core.format.DateFormat");

/**
 * Returns comparator function for supplied Custom Attribute data type
 * 
 * @param {string} sType data type of Custom Attribute e.g. "Edm.Boolean"
 * @return {function} a Custom Attribute Comparator function for corresponding sType
 * @public
 */
cross.fnd.fiori.inbox.util.CustomAttributeComparator = {
	...
	fnMapBPMTypes: function(sType) {
    	...
    	default:	jQuery.sap.log.info("Can not resolve Custom Attribute Type:<"+sType+">","","cross.fnd.fiori.inbox.util.CustomAttributeComparator.fnMapBPMTypes");
    				return "Edm.String";
		}	
	...
	fnTimeParser: function(sTime) {
		...
		if (a[0] == "/Date") return parseInt(a[1]);
	...
	fnDurationParser: function(sDuration) {
		...
		var re = /[^0-9]/;		// Time Diration Format	"HHMMSS". Old TGW format.
